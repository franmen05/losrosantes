<?php
	...
	{	
		...
		private function _initializer(){
			$this->conection = ConectionToMySQL::getInstance("nominalosrosante.db.7306008.hostedresource.com","g.G654789","nominalosrosante","nominalosrosante");	
		}
		
		public function getNoticias(){
			$objArray=  array();
			$result=$this->conection->query("select * from prueba");
			$i=0;
		 	while($line= $this->conection->fetch_Array($result)){
				$objArray[]= array('a'=>$line["a"],'e'=>$line["e"]);
		 	}
			return $objArray;
		}
